...
func framesToCaller() int {
	// 1 is the immediate caller.  5 should be too many.
	for i := 1; i < 3; i++ {
...
func (l klogger) Info(msg string, kvList ...interface{}) {
	if l.Enabled() {
		...
		keysAndValues := make([]interface{}, 0, len(trimmed[0])+len(trimmed[1])+2)
		if l.prefix != "" {
			keysAndValues = append(keysAndValues, "prefix", l.prefix)
		}
		keysAndValues = append(keysAndValues, trimmed[0]...)
		keysAndValues = append(keysAndValues, trimmed[1]...)
		klog.InfoDepthS(framesToCaller(), msg, keysAndValues...)
	}
}
...
func (l klogger) Error(err error, msg string, kvList ...interface{}) {
	...
	keysAndValues = append(keysAndValues, trimmed[0]...)
	keysAndValues = append(keysAndValues, trimmed[1]...)
	klog.ErrorDepthS(framesToCaller(), err, msg, keysAndValues...)
}
